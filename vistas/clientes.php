...
<body style="background-image:url(../img/small-address-book.png)">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
								...
								<section class="text-center">
									...
									<span>										
										<div class="text-right">
				                        	<a class="btn btn-outline-info btn-lg-4" href="usuarios.php" role="button">Usuarios</a>
			                      		</div>			                      		
			                      	</span><br>
										<div class="text-right">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmAgregarDatos">
						...
						<input type="text" id="emailContacto" name="emailContacto" class="form-control form-control-sm">
						<label>Ciudad</label>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmAgregarDatosu">						
						...
						<label>Correo Electrónico</label>
						<input type="text" id="emailContactou" name="emailContactou" class="form-control form-control-sm">
						<label>Ciudad</label>
